...
const services = [
    {
        ...
        Description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.Atque dolore ullam perspiciatis voluptatem! Natus dignissimos ",
        link: "Learn More"
    },
    {
        name: "WEB DEVELOPMENT1",
        Description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.Atque dolore ullam perspiciatis voluptatem! Natus dignissimos fuga el",
        link: "Learn More"
    },
    {
        name: "WEB DEVELOPMENT2",
        Description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.Atque dolore ullam perspiciatis voluptatem! Natus dignissimos fuga eligendi n",
        link: "Learn More"
    },
    {
                    ...
                    className="flex-1">
                        <div>
                            {services.map((service, index) => {
                                ...
                                return (
                                    <div className='border-b border-white/20 h-[146px] mb-[42px] flex' key={index}>
