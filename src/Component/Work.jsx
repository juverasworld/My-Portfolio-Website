    ...
    return (<>
        <section className="section" id="work">
            <div className="container section mx-auto">
                <div className="flex flex-col lg:flex-row sm:mt-10 mt-0 gap-x-10">
                    <motion.div
                        ...
                        <div>
                            ...
                            <p className="max-w-sm mb-16"> Some of my most really interesting and highly efficient works</p>
                            <button className="btn btn-sm "> View all Projects</button>
                        </div>
                        <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl" >
                            <div className=" group-hover:bg-black/70 w-full h-full absolute z-40  transition-all duration-300"></div>
                            <img className=" w-[50%] group-hover:scale-125 transition-qll duration-500 " src={logo} alt="" />
